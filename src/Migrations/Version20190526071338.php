 ...
 */
final class Version20190526071338 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE persona (numero_empleado INT AUTO_INCREMENT NOT NULL, departamento_id INT NOT NULL, correo VARCHAR(100) DEFAULT NULL, nombre VARCHAR(100) NOT NULL, apellidos VARCHAR(100) NOT NULL, cargo VARCHAR(100) NOT NULL, telefono VARCHAR(50) DEFAULT NULL, Local_id INT NOT NULL, INDEX IDX_51E5B69BA42C4357 (Local_id), INDEX IDX_51E5B69B5A91C08D (departamento_id), PRIMARY KEY(numero_empleado)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
